    ...
    >
      <CardContent className="flex h-full flex-1 flex-col p-4">
        <div className="flex flex-1 flex-col gap-3">
          ...
          <div className="absolute end-3 top-3 flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-pink-600 shadow-lg transition-transform duration-300 ease-out motion-safe:group-hover:scale-110">
            <Icon className="h-6 w-6 text-white" />
          </div>

          {/* Title — inset spacing for icon on inline end */}
          <div className="flex min-h-10 items-center pe-14">
            <p className="text-base font-medium text-gray-700 dark:text-gray-200">{title}</p>
          </div>

          <div className="text-start text-3xl font-bold text-gray-900 dark:text-gray-100">{value}</div>

          <div className="mt-2 flex flex-row items-center gap-1.5 text-start">
